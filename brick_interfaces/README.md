...
This package defines the custom ROS 2 interface messages used by the Brick Sorting application. 

## Custom Message `LegoBrick.msg`

Used to publish the consolidated data of a detected brick, including its calculated 3D position in the robot's coordinate system, its color, and the raw depth distance from the camera.
