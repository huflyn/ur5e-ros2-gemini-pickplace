''' A simple script to demonstrate how to use the Gemini API by sending a prompt and printing the response. You can also provide a custom prompt as a command line argument. '''
