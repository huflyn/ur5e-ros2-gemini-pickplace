...
class ColorDetectorOldNode(Node):
    def __init__(self):
        super().__init__('color_detector_old_node')
        ...
        for color in colors:
            ...
            for cnt in contours:
                ...
                if rel_area > 0.001:
                    ...
                    # --- Safe Zone Check: Split into X and Y margins ---
